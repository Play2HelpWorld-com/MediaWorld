...
const BlogData: Charity[] = [
  {
    ...
    title: "Media World World Water Aid",
    metadata:
      "Media World, an innovative platform where gaming meets social impact. Designed to bring entertainment and purpose together, Media World allows users to play exciting games, earn coins, and contribute to meaningful social causes.",
  },
  {
    ...
    title: "Media World World WWF",
    metadata:
      "Media World offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
  {
    ...
    title: "Media World World MSF Doctors Without Borders",
    metadata: "Media World offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
  {
  ...
  },
  {
    ...
    title: "Media World Cancer Research",
    metadata: "Media World offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
  {
  ...
  },
  {
    ...
    title: "Media World Alzheimer's Society",
    metadata: "Media World offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
  {
